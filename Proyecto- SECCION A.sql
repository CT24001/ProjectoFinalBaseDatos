...
INNER JOIN Asignacion a ON e.empleado_id = a.empleado_id
INNER JOIN Proyecto p ON p.proyecto_id = a.proyecto_id;
...
FROM Proyecto p
INNER JOIN Asignacion a ON p.proyecto_id = a.proyecto_id
INNER JOIN Empleado e ON a.empleado_id = e.empleado_id
...
FROM empleado e
INNER JOIN departamento d ON e.departamento_id = d.departamento_id
INNER JOIN localizacion l ON d.localizacion_id = l.localizacion_id
INNER JOIN pais p ON l.pais_id = p.pais_id
